...
#include <vector>
 ...
 const string name = "mu50";
 const Int_t max = 100;
 const Double_t threshold_SA = 0;
 ...
 void efficiency_mu50(){
  TFile *tf1 = TFile::Open("../src/Zmumu.root","read");
  TTree *tr1 = dynamic_cast<TTree*>(tf1->Get("t_tap"));
  TH2F *h_probe_mesSA_pt = new TH2F("probe_mesSA_pt","probe_pt vs probe_mesSA_pt@mu50;probe_pt[GeV];probe_mesSA_pt[GeV]",150,0,150,150,0,150);
...
*/
  draw_efficiency(h_eff_off_SA_pt,h_eff_off_L1_pt,"L1vsSA_efficiency@mu50;offline pt[GeV];efficiency","../output/L1vsSA_efficiency@mu50.png");
  draw_efficiency(h_eff_off_CB_pt,h_eff_off_SA_pt,"SAvsCB_efficiency@mu50;offline pt[GeV];efficiency","../output/SAvsCB_efficiency@mu50.png");
  draw_efficiency(h_eff_off_EF_pt,h_eff_off_CB_pt,"CBvsEF_efficiency@mu50;offline pt[GeV];efficiency","../output/CBvsEF_efficiency@mu50.png");
